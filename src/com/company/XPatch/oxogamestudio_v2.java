...
public class oxogamestudio_v2 {
    ...
    public void setMaster (String setM){
        ...
        dr.findElement (By.xpath("//input[@name='master']")).sendKeys(setM);
    }

    public void setName (String setN){
        //dr.findElement(By.name("site")).sendKeys(setN, Keys.ENTER);
        dr.findElement(By.xpath("//input[@name='site']")).sendKeys(setN, Keys.ENTER);
    }

    public String getPassword(){
        //String getPass =  dr.findElement(By.name("password")).getAttribute("value");
        String getPass =  dr.findElement(By.xpath("//input[@name='password']")).getAttribute("value");
        return getPass;
    }
