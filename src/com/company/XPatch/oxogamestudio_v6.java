...
public class oxogamestudio_v6 {
    ...
    public void setMaster (String setM){
        ...
        dr.findElement (By.xpath("//input[@type='password']")).sendKeys(setM);
    }

    public void setName (String setN){
        //dr.findElement(By.name("site")).sendKeys(setN, Keys.ENTER);
        dr.findElement(By.xpath("//tr[2]/td/input")).sendKeys(setN, Keys.ENTER);
    }

    public String getPassword(){
        //String getPass =  dr.findElement(By.name("password")).getAttribute("value");
        String getPass =  dr.findElement(By.xpath("//*[@class='output']/td/input")).getAttribute("value");
        return getPass;
    }
